package com.example.smsgroups.ui.creategroup;
...
public class GroupAdapter  extends RecyclerView.Adapter<GroupAdapter.GroupViewHolder> {
    ...
    public GroupViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        GroupViewHolder holder = new GroupViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_creategroup_group, parent, false));
        return holder;
    }
